 ...
 implements ChatApp.ChatOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("placeMarker", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // ChatApp/Chat/joinGame
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         String piece = in.read_string ();
         this.joinGame (objref, piece);
         out = $rh.createReply();
         break;
       }

       case 5:  // ChatApp/Chat/placeMarker
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         String position = in.read_string ();
         this.placeMarker (objref, position);
         out = $rh.createReply();
         break;
       }
